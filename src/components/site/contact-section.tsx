...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="relative isolate overflow-hidden bg-[#0B0C0C] px-5 py-20 text-white sm:px-8 lg:px-16"
    >
        ...
        <Reveal delay={120}>
          ...
          <form className="rounded-lg border border-white/10 bg-transparent">
            ...
            <div className="grid gap-4 p-6 sm:grid-cols-2 sm:p-8">
              ...
              <button
                type="button"
                className="inline-flex min-h-14 items-center justify-center gap-2 rounded-xl bg-primary px-6 text-sm font-bold text-white transition hover:bg-primary-hover sm:col-span-2"
              >
